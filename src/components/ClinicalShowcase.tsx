    ...
    >
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div ref={headerRef} className="text-center max-w-3xl mx-auto mb-10 sm:mb-12">
          <div className="inline-flex items-center gap-2 bg-blue-50 border border-blue-100 text-[#2B64EC] px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider mb-4">
          ...
          <p className="mt-3.5 text-slate-500 text-sm sm:text-base leading-relaxed">
            Scroll or drag along the gallery to explore our modern dental technology, hospital-grade sterilization, and calming operatory suite.
          </p>

          <div
            ref={badgeRef}
            className="mt-4 inline-flex items-center gap-2 text-xs font-semibold text-slate-500 bg-slate-100/80 px-3.5 py-1 rounded-full select-none"
          >
            <MoveHorizontal className="w-3.5 h-3.5 text-blue-600 animate-pulse" />
            <span>Drag horizontally or scroll to navigate gallery</span>
          </div>
        </div>

        {/* GSAP Zoom Slider Component with Default Website Background */}
